...
BEGIN 
    ...
    ELSIF operacion = 5 THEN -- Insertar compra_pedido_detalle
        ...
        PERFORM * FROM vent_cobros_det WHERE id_cob = xid_cob;
        IF FOUND THEN
            RAISE EXCEPTION 'ESTA CUENTA YA HA SIDO REGISTRADO EN EL PEDIDO';
        END IF;
    ...
    elseif operacion = 9 then
     ...
     values((SELECT COALESCE(MAX(id_ctar), 0) + 1 FROM cobros_tarjetas),xtar_nro_tarjeta,xtar_vencimiento,xtar_monto,xid_cob,xid_ee,xid_mt,'ACTIVO','INSERCION/' || usuario || '/' || NOW());
    		RAISE NOTICE 'DATOS AÑADIDO CON ÉXITO';
...
DECLARE
  ...
  cuota_monto NUMERIC := CASE WHEN xvc_cuota > 0 THEN xmonto / xvc_cuota ELSE xmonto END;
...
PERFORM * FROM ventas_cab WHERE id_vc = xid_vc AND estado = 'PENDIENTE';
    ...
    FOR d IN SELECT id_item, catidad,id_sucursal FROM v_ventas_consolidacion WHERE id_vc = xid_vc loop 
      ...
      --INSERTAR CUENTA A PAGAR
        ...
        INSERT INTO vent_cuentas_cobrar (id_cue, id_vc, cue_monto, cue_saldo, estado, auditoria)
        VALUES (
            (SELECT COALESCE(MAX(id_cue), 0) + 1 FROM vent_cuentas_cobrar),
            xid_vc, cuota_monto, saldo, 'ACTIVO', 
            'INSERCION/' || usuario || '/' || NOW()
        );
        saldo := saldo - cuota_monto;
    	END LOOP;
   ----------------------------------------------------------------------------------------------------------------------------------
     --CERRAR MOVIMIENTO TRAIDO DESDE OTRO MOVIMIENTO 
...
CREATE VIEW public.v_cobros_tarjetas AS
 SELECT cd.id_ctar,
   ...
   FROM (((public.cobros_tarjetas cd
     JOIN public.entidades_adheridas f ON ((f.id_ee = cd.id_ee)))
     JOIN public.entidades_emisoras ee ON ((ee.id_ee = f.id_ee)))
     JOIN public.marcas_tarjetas mt ON ((mt.id_mt = f.id_mt)));
...
4	2025-04-06	2025-04-17	1	1	PENDIENTE	INSERCION/admin/2025-04-06 14:05:18.761541-04
...
1	0	636	0	ACTIVO	INSERCION/admin/2025-02-24 21:02:08.061068-03
...
8	45678901	RECIBO	2024-01-01	2024-03-31	2	500	2	3	ACTIVO	\N
1	12345678	FACTURA	2024-01-01	2024-12-31	2	9999	1	1	ACTIVO	\N
2	87654321	FACTURA	2024-02-01	2024-12-31	3	5000	1	2	ACTIVO	\N
3	54321678	FACTURA	2024-03-01	2024-12-31	6	3000	2	1	ACTIVO	\N
\.
...
1	1	1	1	1	2025-04-15 00:20:34	PENDIENTE	INSERCION/admin/2025-04-14 20:20:49.752861-04	3
\.
...
1	13	4	50000	INSERCION/admin/2025-04-19 20:17:32.252501-04
\.
...
1	1	583	7000	ACTIVO	INSERCION/admin/2025-02-24 21:02:08.061068-03
2	1	583	6417	ACTIVO	INSERCION/admin/2025-02-24 21:02:08.061068-03
3	1	583	5833	ACTIVO	INSERCION/admin/2025-02-24 21:02:08.061068-03
4	1	583	5250	ACTIVO	INSERCION/admin/2025-02-24 21:02:08.061068-03
5	1	583	4667	ACTIVO	INSERCION/admin/2025-02-24 21:02:08.061068-03
6	1	583	4083	ACTIVO	INSERCION/admin/2025-02-24 21:02:08.061068-03
7	1	583	3500	ACTIVO	INSERCION/admin/2025-02-24 21:02:08.061068-03
8	1	583	2917	ACTIVO	INSERCION/admin/2025-02-24 21:02:08.061068-03
9	1	583	2333	ACTIVO	INSERCION/admin/2025-02-24 21:02:08.061068-03
10	1	583	1750	ACTIVO	INSERCION/admin/2025-02-24 21:02:08.061068-03
11	1	583	1167	ACTIVO	INSERCION/admin/2025-02-24 21:02:08.061068-03
12	1	583	583	ACTIVO	INSERCION/admin/2025-02-24 21:02:08.061068-03
13	3	146875	1762500	ACTIVO	INSERCION/admin/2025-02-24 21:46:59.181475-03
14	3	146875	1615625	ACTIVO	INSERCION/admin/2025-02-24 21:46:59.181475-03
15	3	146875	1468750	ACTIVO	INSERCION/admin/2025-02-24 21:46:59.181475-03
16	3	146875	1321875	ACTIVO	INSERCION/admin/2025-02-24 21:46:59.181475-03
17	3	146875	1175000	ACTIVO	INSERCION/admin/2025-02-24 21:46:59.181475-03
18	3	146875	1028125	ACTIVO	INSERCION/admin/2025-02-24 21:46:59.181475-03
19	3	146875	881250	ACTIVO	INSERCION/admin/2025-02-24 21:46:59.181475-03
20	3	146875	734375	ACTIVO	INSERCION/admin/2025-02-24 21:46:59.181475-03
21	3	146875	587500	ACTIVO	INSERCION/admin/2025-02-24 21:46:59.181475-03
22	3	146875	440625	ACTIVO	INSERCION/admin/2025-02-24 21:46:59.181475-03
23	3	146875	293750	ACTIVO	INSERCION/admin/2025-02-24 21:46:59.181475-03
24	3	146875	146875	ACTIVO	INSERCION/admin/2025-02-24 21:46:59.181475-03
25	4	7000	84000	ACTIVO	INSERCION/admin/2025-02-24 22:30:37.333658-03
26	4	7000	77000	ACTIVO	INSERCION/admin/2025-02-24 22:30:37.333658-03
27	4	7000	70000	ACTIVO	INSERCION/admin/2025-02-24 22:30:37.333658-03
28	4	7000	63000	ACTIVO	INSERCION/admin/2025-02-24 22:30:37.333658-03
29	4	7000	56000	ACTIVO	INSERCION/admin/2025-02-24 22:30:37.333658-03
30	4	7000	49000	ACTIVO	INSERCION/admin/2025-02-24 22:30:37.333658-03
31	4	7000	42000	ACTIVO	INSERCION/admin/2025-02-24 22:30:37.333658-03
32	4	7000	35000	ACTIVO	INSERCION/admin/2025-02-24 22:30:37.333658-03
33	4	7000	28000	ACTIVO	INSERCION/admin/2025-02-24 22:30:37.333658-03
34	4	7000	21000	ACTIVO	INSERCION/admin/2025-02-24 22:30:37.333658-03
35	4	7000	14000	ACTIVO	INSERCION/admin/2025-02-24 22:30:37.333658-03
36	4	7000	7000	ACTIVO	INSERCION/admin/2025-02-24 22:30:37.333658-03
37	5	250000	250000	ACTIVO	INSERCION/admin/2025-02-26 15:06:42.457981-03
38	6	257000	257000	ACTIVO	INSERCION/admin/2025-02-26 15:37:50.67759-03
39	7	7000	7000	ACTIVO	INSERCION/admin/2025-02-26 15:40:32.762475-03
\.
...
1	2025-01-28	CREDITO	12	15	002-003-0000001	8	1	1	3	CONFIRMADO	INSERCION/admin/2025-01-28 14:51:47.184299-03\rMODIFICACION/admin/2025-02-02 14:39:11.637967-03\rMODIFICACION/admin/2025-02-02 14:47:28.399351-03\rMODIFICACION/admin/2025-02-02 14:47:35.158329-03\rCONFIRMACION/admin/2025-02-02 20:43:05.621405-03\rCONFIRMACION/admin/2025-02-24 21:02:08.061068-03
2	2025-02-25	CONTADO	0	0	001-001-0000001	1	1	1	2	CONFIRMADO	INSERCION/admin/2025-02-24 21:13:41.566348-03
...
8	2025-02-26	CONTADO	0	0	002-001-0000006	3	1	1	3	PENDIENTE	INSERCION/admin/2025-02-26 15:59:44.672865-03
\.
...
ALTER TABLE ONLY public.devoluciones
    ADD CONSTRAINT devoluciones_pkey PRIMARY KEY (id_cob);
...
ALTER TABLE ONLY public.vent_cobros_det
    ADD CONSTRAINT vent_cobros_det_pkey PRIMARY KEY (id_cob);
...
ALTER TABLE ONLY public.cobros_cheques
    ADD CONSTRAINT cobros_cheques_id_cob_fkey FOREIGN KEY (id_cob) REFERENCES public.vent_cobros_det(id_cob);
...
ALTER TABLE ONLY public.cobros_tarjetas
    ADD CONSTRAINT cobros_tarjetas_id_cob_fkey FOREIGN KEY (id_cob) REFERENCES public.vent_cobros_det(id_cob);
...
ALTER TABLE ONLY public.cobros_transferencia
    ADD CONSTRAINT cobros_transferencia_id_cob_fkey FOREIGN KEY (id_cob) REFERENCES public.vent_cobros_det(id_cob);
...
ALTER TABLE ONLY public.devoluciones
    ADD CONSTRAINT devoluciones_id_cob_fkey FOREIGN KEY (id_cob) REFERENCES public.vent_cobros_det(id_cob);


--
-- Name: devoluciones devoluciones_id_cue_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.devoluciones
    ADD CONSTRAINT devoluciones_id_cue_fkey FOREIGN KEY (id_cue) REFERENCES public.vent_cuentas_cobrar(id_cue);
