...
--
-- Name: v_ventas_lib_cuent; Type: VIEW; Schema: public; Owner: postgres
--

CREATE VIEW public.v_ventas_lib_cuent AS
 SELECT cc.id_vc,
    cc.vc_fecha,
    cc.vc_tipo_factura,
    cc.vc_cuota,
    ...
    ccp.estado AS estadocue
   FROM ((public.ventas_cab cc
     JOIN public.libro_ventas lc ON ((lc.id_vc = cc.id_vc)))
     JOIN public.vent_cuentas_cobrar ccp ON ((ccp.id_vc = cc.id_vc)));


ALTER TABLE public.v_ventas_lib_cuent OWNER TO postgres;
...
1	1	1	1	2025-02-08 18:07:37	2025-02-08 18:07:45	400000	600000	140000	100000	1140000	CONFIRMADO	INSERCION/admin/2025-02-08 15:07:45.064706-03\rMODIFICACION/admin/2025-02-08 15:08:25.770318-03\rCONFIRMACION/admin/2025-02-08 15:17:18.142813-03
2	1	1	1	2025-02-08 15:15:19	2025-02-08 15:15:38	300000	620000	750000	140000	1670000	CERRADO	INSERCION/admin/2025-02-08 15:15:37.867016-03\rMODIFICACION/admin/2025-02-08 15:16:23.474148-03\rMODIFICACION/admin/2025-02-08 15:30:05.41286-03
3	1	1	1	2025-02-08 15:24:35	2025-02-08 15:31:50	900000	450000	243000	300000	1593000	CERRADO	INSERCION/admin/2025-02-08 15:24:45.229079-03\rCERRADO/admin/2025-02-08 15:37:04.041591-03
\.
...
COPY public.vent_cuentas_cobrar (id_vc, cue_monto, cue_saldo, estado, auditoria) FROM stdin;
1	31000	31000	ACTIVO	INSERCION/admin/2025-02-02 20:43:05.621405-03
\.
...
ALTER TABLE ONLY public.vent_cuentas_cobrar
    ADD CONSTRAINT vent_cuentas_cobrar_pkey PRIMARY KEY (id_vc);
