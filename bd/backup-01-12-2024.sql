...
CREATE FUNCTION public.sp_mediciones(xid_med integer, xmed_fecha date, xmed_edad integer, xmed_observacion text, xid_cliente integer, xid_personal integer, xid_sucursal integer, xid_funcionario integer, xid_tip_med integer, xvalor numeric, usuario character varying, operacion integer) RETURNS void
    LANGUAGE plpgsql
    AS $$
DECLARE
    d RECORD;
BEGIN 
    ...
    ELSIF operacion = 5 THEN 
	  		...
	  		-- INSERTAR DETALLES
        INSERT INTO serv_mediciones_det (id_med,id_tip_med,valor,auditoria)
        VALUES (xid_med, xid_tip_med, xvalor,
    ...
    -- MODIFICAR DETALLE --
        ...
        id_tip_med = xid_tip_med,
        valor = xvalor,
        auditoria = COALESCE(auditoria, '') || CHR(13) || 'MODIFICACION/' || usuario || '/' || NOW()
        WHERE id_med = xid_med AND id_plan_servi = xid_plan_servi;
        RAISE NOTICE 'MEDICIÓN MODIFICADO CON ÉXITO';
       
    ELSIF operacion = 7 THEN 
    -- ELIMINAR DETALLE
    DELETE FROM serv_mediciones_det
        WHERE id_med = xid_med AND id_tip_med = xid_tip_med;
...
ALTER FUNCTION public.sp_mediciones(xid_med integer, xmed_fecha date, xmed_edad integer, xmed_observacion text, xid_cliente integer, xid_personal integer, xid_sucursal integer, xid_funcionario integer, xid_tip_med integer, xvalor numeric, usuario character varying, operacion integer) OWNER TO postgres;
...
--
-- Name: tipo_medicion; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.tipo_medicion (
    id_tip_med integer NOT NULL,
    tip_descrip character varying(100),
    tip_unidad character varying(20),
    estado public.estados,
    auditoria text
);


ALTER TABLE public.tipo_medicion OWNER TO postgres;
...
CREATE VIEW public.v_serv_mediciones_det AS
 SELECT md.id_med,
   ...
   FROM ((public.serv_mediciones_det md
     ...
     JOIN public.tipo_medicion tm ON ((tm.id_tip_med = md.id_tip_med)));
...
CREATE VIEW public.v_serv_mediciones_foot AS
 SELECT cnc.id_med,
   ...
   FROM ((((public.serv_mediciones_cab cnc
     LEFT JOIN public.serv_mediciones_det smd_peso ON (((smd_peso.id_med = cnc.id_med) AND (smd_peso.id_tip_med = 1))))
     LEFT JOIN public.serv_mediciones_det smd_altura ON (((smd_altura.id_med = cnc.id_med) AND (smd_altura.id_tip_med = 4))))
...
1	2024-11-28	27	llll	1	4	1	1	CONFIRMADO	INSERCION/admin/2024-11-28 13:43:56.235554-03\rCONFIRMACION/admin/2024-11-28 21:41:16.239422-03
...
COPY public.serv_mediciones_det (id_med, id_tip_med, valor, auditoria) FROM stdin;
1	1	80	INSERCION DETALLE/admin/2024-11-28 20:53:52.679623-03
1	4	1.80	INSERCION DETALLE/admin/2024-11-28 20:53:28.560581-03
2	4	1.80	INSERCION DETALLE/admin/2024-11-29 23:09:00.233256-03
2	1	80	INSERCION DETALLE/admin/2024-11-29 23:09:10.301499-03
3	4	1.80	INSERCION DETALLE/admin/2024-11-30 14:31:38.208166-03
3	1	80	INSERCION DETALLE/admin/2024-11-30 14:31:46.924495-03
\.
...
1	2024-11-08	2024-12-10	N/A	2	1	1	PENDIENTE	INSERCION/admin/2024-11-08 14:51:51.626749-03\rMODIFICACION/admin/2024-11-08 22:05:36.597009-03\rMODIFICACION/admin/2024-11-08 22:06:24.951552-03\rMODIFICACION/admin/2024-11-08 22:07:21.728037-03\rMODIFICACION/admin/2024-11-08 22:09:46.487707-03
\.
...
--
-- Data for Name: tipo_medicion; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.tipo_medicion (id_tip_med, tip_descrip, tip_unidad, estado, auditoria) FROM stdin;
1	PESO 	kg	ACTIVO	\N
2	CINTURA	cm	ACTIVO	\N
3	CADERA	cm	ACTIVO	\N
4	ALTURA	m	ACTIVO	\N
\.
...
ALTER TABLE ONLY public.serv_mediciones_det
    ADD CONSTRAINT serv_mediciones_det_pkey PRIMARY KEY (id_med, id_tip_med);
...
--
-- Name: tipo_medicion tipo_medicion_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.tipo_medicion
    ADD CONSTRAINT tipo_medicion_pkey PRIMARY KEY (id_tip_med);
...
--
-- Name: serv_mediciones_det serv_mediciones_det_id_tip_med_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.serv_mediciones_det
    ADD CONSTRAINT serv_mediciones_det_id_tip_med_fkey FOREIGN KEY (id_tip_med) REFERENCES public.tipo_medicion(id_tip_med);
