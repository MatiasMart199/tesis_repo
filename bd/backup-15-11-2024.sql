...
BEGIN 
    IF operacion = 1 THEN --INSERTAR CABECERA
        ...
        -- Inserta 
        INSERT INTO comp_ajustes_cab (id_caju, aju_fecha, id_sucursal, id_funcionario, estado, auditoria)
		VALUES ((SELECT COALESCE(MAX(id_caju), 0) + 1 FROM comp_ajustes_cab), 
		Xaju_fecha, xid_sucursal, xid_funcionario, 'PENDIENTE', 'INSERCION/' || usuario || '/' || NOW());
    ...
    ELSIF operacion = 2 THEN -- MODIFICAR CABECERA
        ...
        UPDATE comp_ajustes_cab SET aju_fecha = xaju_fecha, auditoria = COALESCE(auditoria, '') || CHR(13) || 'MODIFICACION/' || usuario || '/' || NOW()
    ...
    ELSIF operacion = 5 THEN -- INSERTAR DETALLE
        ...
        END IF;
        -- Inserta el detalle 
	       insert into motivo_ajustes (mot_descrip, mot_tipo_ajuste)
	      values(xmot_descrip, xmot_tipo_ajuste);
     

        INSERT INTO comp_ajustes_det (id_caju, id_item, id_motivo, cantidad, precio, auditoria)
        VALUES (xid_caju, xid_item, (select max(id_motivo) from motivo_ajustes), xcantidad, (SELECT precio_compra FROM items WHERE id_item = xid_item), 
       'INSERCION/' || usuario || '/' || NOW());
    ...
    ELSIF operacion = 6 THEN -- MODIFICAR DETALLE
        ...
        UPDATE comp_ajustes_det SET cantidad = xcantidad, precio = (SELECT precio_compra FROM items WHERE id_caju = xid_caju AND id_item = xid_item)
    ...
    ELSIF operacion = 7 THEN -- ELIMINAR DETALLE
       ...
       DELETE FROM motivo_ajustes WHERE id_motivo = xid_motivo;
...
COPY public.comp_ajustes_cab (id_caju, aju_fecha, id_sucursal, id_funcionario, estado, auditoria) FROM stdin;
1	2024-11-14	1	1	CONFIRMADO	INSERCION/admin/2024-11-13 21:59:47.990533-03\rCONFIRMACION/admin/2024-11-14 11:29:20.546275-03
\.
...
1	3	5	3	300000	INSERCION/admin/2024-11-14 11:28:06.970299-03
\.
...
COPY public.motivo_ajustes (id_motivo, mot_descrip, mot_tipo_ajuste) FROM stdin;
5	Sobrante	NEGATIVO
\.
...
1	MATIAS	MARTINEZ	6321987-0	6321987	XXX-2312	matiasmarfe@gmail.com	1995-11-04	0987234567	t	ACTIVO	INSERCION/admin/2023-10-31 16:59:03.174228-03\rINACTIVACIONadmin/2023-10-31 22:50:23.486386-03\rACTIVACIONadmin/2023-10-31 22:50:31.219195-03	1	1	1
\.
...
7	2024-11-06	2024-11-09	N/A	1	1	2	PENDIENTE	INSERCION/admin/2024-11-06 20:14:26.043353-03\rCONFIRMACION/admin/2024-11-06 20:20:26.046576-03\rCONFIRMACION/admin/2024-11-09 15:33:14.477842-03
\.
...
SELECT pg_catalog.setval('public.motivo_ajustes_id_motivo_seq', 5, true);
