...
--
-- Name: sp_compras(integer, date, date, character varying, integer, numeric, numeric, numeric, numeric, numeric, integer, integer, integer, integer, integer, integer, integer, character varying, integer); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.sp_compras(xid_cc integer, xcc_fecha date, xcc_validez date, xcc_tipo_factura character varying, xcc_cuota integer, xiva5 numeric, xiva10 numeric, xexenta numeric, xmonto numeric, xsaldo numeric, xid_sucursal integer, xid_funcionario integer, xid_proveedor integer, xid_item integer, xcantidad integer, xprecio integer, xid_corden integer, usuario character varying, operacion integer) RETURNS void
    LANGUAGE plpgsql
    AS $$
DECLARE
    d RECORD;
...
ALTER FUNCTION public.sp_compras(xid_cc integer, xcc_fecha date, xcc_validez date, xcc_tipo_factura character varying, xcc_cuota integer, xiva5 numeric, xiva10 numeric, xexenta numeric, xmonto numeric, xsaldo numeric, xid_sucursal integer, xid_funcionario integer, xid_proveedor integer, xid_item integer, xcantidad integer, xprecio integer, xid_corden integer, usuario character varying, operacion integer) OWNER TO postgres;
...
CREATE VIEW public.v_compras_cab AS
 SELECT cc.id_cc,
    ...
    to_char((cc.cc_validez)::timestamp with time zone, 'DD/MM/YYYY'::text) AS fecha_intervalo,
    s.suc_nombre,
    s.suc_direccion,
    s.suc_correo,
    s.suc_telefono,
...
CREATE VIEW public.v_compras_consolidacion AS
 SELECT c.id_cc,
  ...
  GROUP BY c.id_cc, c.id_item, c.precio, c.item_descrip, c.id_mar, c.id_tip_item, c.mar_descrip, c.tip_item_descrip;
...
1	2024-08-30	2025-08-30	CONTADO	0	1	1	1	PENDIENTE	\N
\.
...
3	2024-02-03	2024-02-03	CONTADO	0	1	1	1	PENDIENTE	INSERCION/admin/2024-02-03 15:26:55.585886-03\rMODIFICACION/admin/2024-02-03 15:28:13.458814-03\rANULACION/admin/2024-08-23 14:48:43.203613-04
4	2024-08-30	2024-08-22	CREDITO	2	1	1	1	PENDIENTE	INSERCION/admin/2024-08-29 20:55:32.404053-04
\.
...
5	2024-06-18	2024-06-18		1	1	1	PENDIENTE	INSERCION/admin/2024-06-18 15:21:39.774769-04
\.
