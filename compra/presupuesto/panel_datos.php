    ...
    <div class="row">
        <div class="card card-primary col-12">
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    <label>Sucursal</label>
                    <input type="text" value="<?= $presupuestos[0]['suc_nombre']; ?>" class="form-control" disabled>
                </div>
                <div class="form-group">
                    <label>Fecha</label>
                    <input type="date" value="<?= $presupuestos[0]['cpre_fecha']; ?>" class="form-control" id="cpre_fecha" disabled>
                </div>
                <div class="form-group">
                    <label>Valido Hasta</label>
