...
$datos = pg_fetch_all(pg_query($conn, "SELECT * FROM v_compras_presupuestos_pedidos WHERE id_cpre = $id_cpre AND id_item = $id_item;"));
?>
        ...
        <div class="card card-warning">
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" disabled="" value="<?= $datos[0]['item_descrip']." - ".$datos[0]['mar_descrip']; ?>" class="form-control">
                </div>
                <div class="form-group">
            ...
            <div class="modal-footer justify-content-between">
                ...
                <button class="btn btn-warning text-white" onclick="modificar_detalle_ped_grabar();"><i class="fa fa-save"></i> Grabar</button>
            </div>
        </div>
    </div>
</div>
