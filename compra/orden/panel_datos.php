        ...
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col-md-1">
                    ...
                    <input type="number" value="0" class="form-control" id="ord_intervalo" disabled>
                </div>

                <div class="col-md-1">
                    <label>Cuota</label>
                    <input type="number" value="0" class="form-control" id="ord_cuota" disabled>
                </div>
            </div>
    ...
    <div class="row">
        <div class="card card-primary col-12">
            ...
            <div class="card-body">
                ...
                <input type="hidden" value="<?php echo $ordenes_pedidos[0]['id_cpre']; ?>" id="id_cpre">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            <label>Proveedor</label>
                            <select class="select2" id="id_proveedor">
                                <option selected="true" value="<?= $ordenes[0]['id_proveedor']; ?>"><?= $ordenes[0]['proveedor']; ?></option>
                                <?php foreach ($proveedores as $pr) { ?>
                                    <option value="<?php echo $pr['id_proveedor']; ?>">
                                        <?php echo $pr['proveedor'] . " " . $pr['per_ruc']; ?>
                                    </option>
                ...
                <div class="row">
                    <div class="col-md-10">
                        <div class="form-group">
                            <label>Tipo de Factura</label>
                            <select class="select2" id="ord_tipo_factura">
                                <option selected="true" value="<?= $ordenes[0]['ord_tipo_factura']; ?>"><?= $ordenes[0]['ord_tipo_factura']; ?></option>
                                <option value="CONTADO">CONTADO</option>
                                <option value="CREDITO">CRÉDITO</option>
                            </select>
                        </div>
                    ...
                    <div class="col-md-1">
                        <div class="form-group">
                            <label>Intervalo</label>
                            <input type="number" value="<?= $ordenes[0]['ord_intervalo']; ?>" class="form-control" id="ord_intervalo" disabled>
                        </div>
                    </div>
                    ...
                    <div class="col-md-1">
                        <div class="form-group">
                            <label>Cuota</label>
                            <input type="number" value="<?= $ordenes[0]['ord_cuota']; ?>" class="form-control" id="ord_cuota" disabled>
                        </div>
                    </div>
                </div>
