...
$conn = $conexion->getConexion();
    $datos = pg_fetch_all(pg_query($conn, "SELECT * FROM v_compras_orden_presu WHERE id_corden = $id_corden AND id_item = $id_item;")); 
?>
    ...
    <div class="modal-content">
        <div class="card card-warning">
            ...
            <div class="modal-footer justify-content-between">
                ...
                <button class="btn btn-warning text-white" onclick="modificar_detalle_pre_grabar();"><i class="fa fa-save"></i> Grabar</button>
            </div>
        </div>
    </div>
</div>