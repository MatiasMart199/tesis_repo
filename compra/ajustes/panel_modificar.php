...
$datos = pg_fetch_all(pg_query($conn, "SELECT * FROM v_comp_ajustes_det WHERE id_caju = $id_caju AND id_item = $id_item;"));
?>
<div class="modal-dialog">
    <div class="modal-content">
        <div class="card card-warning">
            ...
            <div class="card-body">
            <input type="hidden" id="modificar_id_item" value="<?= $id_item ?>">
                ...
                <div class="form-group">
                    <label>Motivo</label> 
                    <input type="text" disabled="" value="<?php echo $datos[0]['mot_descrip'] ?>" class="form-control">
                </div>
                <div class="form-group">
