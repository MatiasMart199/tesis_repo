...
$cabecera = pg_fetch_all(pg_query($conn, "SELECT * FROM v_comp_ajustes_cab WHERE id_sucursal = $id_sucursal ORDER BY id_caju;"));
?>
<button class="btn btn-success" onclick="agregar();"><i class="fa fa-plus-circle"></i> Agregar</button>
<table width="100%" class="table table-bordered" id="tabla_panel_ajustes">
    <thead>
        <tr>
            <th>#</th>
            <th>Funcionario</th>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                ...
                <button class="btn btn-danger" onclick="datos(<?php echo $p['id_caju']; ?>);"><i class="fa fa-minus-circle"></i></button>
                <?php } ?>
            </td>
        </tr>
        <?php } } ?>
