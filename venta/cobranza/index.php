                ...
                <div class="card">
                    <div class="card-header p-0">
                        <ul class="nav nav-pills ml-auto p-2">
                            <li class="nav-item"><a class="nav-link active" href="#panel-cobros" id="btn-panel-cobros" data-toggle="tab">Cobros</a></li>
                            <li class="nav-item"><a class="nav-link" href="#panel-datos" id="btn-panel-datos" data-toggle="tab">Datos</a></li>
                        </ul>
                    </div>
                    <div class="card-body">
                        <div class="tab-content">
                            <div class="tab-pane active" id="panel-cobros">
                                <label class="text-danger"><i class="fa fa-exclamation-circle"></i> Cargando...</label>
                            </div>
                            <div class="tab-pane" id="panel-datos">
                                <label class="text-danger"><i class="fa fa-exclamation-circle"></i> Seleccione un cobro...</label>
                            </div>
                        </div>
                    </div>
                </div>
