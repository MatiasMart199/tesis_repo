      ...
      <div class="content-wrapper">
            <div class="content-header">
              <div class="container-fluid">
                <div class="row mb-2">
                  <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Apertura y Cierre de Caja</h1>
                ...
                <div class="card">
                    <div class="card-header p-0">
                        <ul class="nav nav-pills ml-auto p-2">
                            <li class="nav-item"><a class="nav-link active" href="#panel-aperturas" id="btn-panel-aperturas" data-toggle="tab">Apertura cierre</a></li>
                            <li class="nav-item"><a class="nav-link" href="#panel-datos" id="btn-panel-datos" data-toggle="tab">Datos</a></li>
                        </ul>
                    </div>
                    <div class="card-body">
                        <div class="tab-content">
                            <div class="tab-pane active" id="panel-aperturas">
                                <label class="text-danger"><i class="fa fa-exclamation-circle"></i> Cargando...</label>
                            </div>
                            <div class="tab-pane" id="panel-datos">
                                <label class="text-danger"><i class="fa fa-exclamation-circle"></i> Seleccione una apertura y cierre...</label>
                            </div>
                        </div>
                    </div>
                </div>
