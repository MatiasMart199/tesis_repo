    ...
    <div class="content-wrapper">
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0 text-dark">Informes de Stock</h1>
              <input type="hidden" id="operacion" value="0">
            </div>
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item active">Informes Varios</li>
                <li class="breadcrumb-item active">Informes de Stock</li>
              </ol>
            </div>
          </div>
        </div>
        ...
        <div class="card">
          <div class="card-header p-0">
            <ul class="nav nav-pills ml-auto p-2">
              <li class="nav-item"><a class="nav-link active" href="#panel-filtros" id="btn-panel-filtros" data-toggle="tab">Filtro</a></li>
              <li class="nav-item"><a class="nav-link" href="#panel-graficos" id="btn-panel-graficos" data-toggle="tab">Graficos</a></li>
            </ul>
          </div>
          <div class="card-body">
            <div class="tab-content">
              <div class="tab-pane active" id="panel-filtros">
                <label class="text-danger"><i class="fa fa-exclamation-circle"></i> Cargando...</label>
              </div>
              <div class="tab-pane" id="panel-graficos">
                <label class="text-danger"><i class="fa fa-exclamation-circle"></i> Seleccione un filtro...</label>
              </div>
            </div>
          </div>
        </div>
