    ...
    <div class="content-wrapper">
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0 text-dark">Presupuesto de Clientes</h1>
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item active">Presupuesto de Clientes</li>
              </ol>
            </div>
          </div>
        </div>
          ...
          <div class="card-header p-0">
            <ul class="nav nav-pills ml-auto p-2">
              <li class="nav-item"><a class="nav-link active" href="#panel-presupuesto" id="btn-panel-presupuesto"
                  data-toggle="tab">Presupuesto de Clientes</a></li>
