    ...
    <div class="content-wrapper">
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0 text-dark">Planes Alimentarios</h1>
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item active">Planes Alimentarios</li>
              </ol>
            </div>
          </div>
        </div>
        ...
        <div class="card">
          <div class="card-header p-0">
            <ul class="nav nav-pills ml-auto p-2">
              <li class="nav-item"><a class="nav-link active" href="#pane-planes" id="btn-pane-planes"
                  data-toggle="tab">Planes Alimenticios</a></li>
          ...
          <div class="card-body">
            <div class="tab-content">
              <div class="tab-pane active" id="pane-planes">
                <label class="text-danger"><i class="fa fa-exclamation-circle"></i> Cargando...</label>
              </div>
              <div class="tab-pane" id="panel-datos">
                <label class="text-danger"><i class="fa fa-exclamation-circle"></i> Seleccione un plan alimentario...</label>
              </div>
