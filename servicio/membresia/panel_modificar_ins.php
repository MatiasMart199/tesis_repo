...
$datos = pg_fetch_all(pg_query($conn, "SELECT * FROM v_serv_inscripciones_membresias WHERE id_mem = $id_mem AND id_plan_servi = $id_plan_servi;"));
?>
    ...
    <div class="modal-content">
        <div class="card card-warning">
            ...
            <div class="modal-footer justify-content-between">
                ...
                <button class="btn btn-warning text-white" onclick="modificar_detalle_ins_grabar();"><i class="fa fa-save"></i> Grabar</button>
            </div>
        </div>
    </div>
</div>