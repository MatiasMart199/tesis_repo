    ...
    <div class="content-wrapper">
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0 text-dark">Membresía</h1>
          ...
          <div class="card-header p-0">
            <ul class="nav nav-pills ml-auto p-2">
              <li class="nav-item"><a class="nav-link active" href="#panel-membresias" id="btn-panel-membresias"
                  data-toggle="tab">Membresías</a></li>
          ...
          <div class="card-body">
            <div class="tab-content">
              ...
              <div class="tab-pane" id="panel-datos">
                <label class="text-danger"><i class="fa fa-exclamation-circle"></i> Seleccione una Membresía...</label>
              </div>
