    ...
    <div class="modal-content">
        <div class="card-success">
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    <label>RUC</label>
                    <input type="text" maxlength="8" class="form-control" id="agregar_ruc">
                </div>
                <div class="form-group">
                    <label>C.I</label>
                    <input type="text" maxlength="10" class="form-control" id="agregar_ci">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" maxlength="10" class="form-control" id="agregar_telefono ">
                </div>
