            ...
            <div class="content-wrapper">
                <div class="content-header">
                    <div class="container-fluid">
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                <h1 class="m-0 text-dark">Tipo de impuesto</h1>
                            </div>
                            <div class="col-sm-6">
                                <ol class="breadcrumb float-sm-right">
                                    <li class="breadcrumb-item active">Referenciales</li>
                                    <li class="breadcrumb-item active">Tipo de impuesto</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                ...
                <section class="content">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <input type="hidden" id="id_tip_impuesto" value="0">
                        ...
                        <div class="card-body" id="panel_datos">
